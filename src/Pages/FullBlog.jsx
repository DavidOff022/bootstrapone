    ...
    <div className="col-md-12">
      ...
      <div className="card card-cascade wider reverse">
        ...
        <div className="view view-cascade overlay">
          <img className="card-img-top" src="https://mdbootstrap.com/img/Photos/Slides/img%20(142).jpg" alt="Sample image" />
          <a href="#!">
        ...
        <div className="card-body card-body-cascade text-center">
          ...
          <h3 className="font-weight-bold"><a>Title of the news</a></h3>
